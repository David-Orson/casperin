...
var PieceScores = [King + 1][8][4]Score{
	...
	{ // Bishop
		{S(-9, -11), S(6, -4), S(14, -10), S(7, -4)},
		{S(3, -25), S(44, -30), S(27, -17), S(14, -8)},
		{S(12, -18), S(33, -12), S(33, -1), S(17, 8)},
		{S(0, -23), S(4, -19), S(12, -4), S(28, -2)},
		{S(-21, -13), S(1, -15), S(-2, -1), S(25, -1)},
		{S(-67, -1), S(-16, -13), S(-37, -1), S(-18, -8)},
