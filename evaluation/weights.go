...
var KingStorm = [2][8][8]Score{
	{
		{S(12, 10), S(-1, 18), S(7, 15), S(4, 18),
			S(8, 6), S(8, 3), S(5, 14), S(-11, -8)},
		{S(16, 9), S(14, 7), S(28, 3), S(-2, 14),
			S(11, 1), S(38, -17), S(18, -11), S(-5, -6)},
		{S(14, 19), S(8, 9), S(12, 10), S(-4, 15),
			S(-4, 10), S(13, 4), S(15, 0), S(-2, 5)},
		{S(6, 7), S(9, -4), S(8, -12), S(-2, -12),
			S(-5, -9), S(11, -14), S(6, -11), S(-9, 4)},
		{S(13, 0), S(8, -2), S(15, -12), S(0, -13),
			S(-1, -7), S(19, -15), S(11, -9), S(-14, 4)},
		{S(24, 9), S(5, 7), S(5, 10), S(-1, 11),
			S(2, 9), S(10, 3), S(8, -5), S(-3, 6)},
		{S(25, 0), S(16, 6), S(19, 2), S(7, 10),
			S(20, 2), S(27, -9), S(19, -6), S(-6, -5)},
		{S(11, 8), S(2, 15), S(9, 6), S(5, 8),
			S(4, 4), S(11, 1), S(7, 10), S(-10, -7)},
	},
	{
		{S(0, 0), S(1, 0), S(-16, -2), S(23, -8),
			S(1, 14), S(-2, 15), S(3, 51), S(-2, -24)},
		{S(0, 0), S(-52, -21), S(-32, 0), S(41, -7),
			S(2, -3), S(3, -7), S(11, 52), S(-7, -2)},
		{S(0, 0), S(-18, -9), S(-18, -10), S(9, -7),
			S(0, -5), S(-11, -17), S(28, 1), S(-10, 2)},
		{S(0, 0), S(-18, -29), S(-16, -25), S(-13, -9),
			S(1, -26), S(0, -48), S(4, -2), S(-12, -7)},
		{S(0, 0), S(-14, -27), S(-9, -26), S(-4, -9),
			S(3, -24), S(0, -54), S(4, -2), S(-8, -5)},
		{S(0, 0), S(-17, -14), S(1, -7), S(16, 0),
			S(4, -3), S(-6, -17), S(28, -37), S(-6, 5)},
		{S(0, 0), S(-45, -11), S(17, -10), S(46, -7),
			S(7, -2), S(-7, -6), S(10, 51), S(-5, -4)},
		{S(0, 0), S(5, 0), S(-12, 5), S(10, -8),
			S(-2, 21), S(-12, 31), S(1, 53), S(-7, -5)},
	},
}
